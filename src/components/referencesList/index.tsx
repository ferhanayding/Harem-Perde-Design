  ...
  const projects = [
    {
      ...
      items: [
        ...
        "Azerbaycan Respublikası Daxili İşlər Nazirliyinin Bərdə Daxili Qoşunlarının Kazarması",
        "Azerbaycan Respublikası Geydiyyat ve Notariat Baş İdaresi - Ədliyyə nazirliyi",
        "Dövlət sərhəd xidməti akademiyası",
        "Azerbaycan Respublikası Ekologiya nazirliyi",
        ...
        // "Azerbaycan Respublikası Daxili İşlər nazirliyi, Polis Akademiyasının Heydər Əliyev Muzeyi",
      ],
    },
    {
